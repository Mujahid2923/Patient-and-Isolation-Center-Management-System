...
ActiveRecord::Schema.define(version: 2022_03_28_033130) do
  ...
  create_table "patients", force: :cascade do |t|
    ...
    t.index ["joining_date"], name: "index_patients_on_joining_date"
    t.index ["release_date"], name: "index_patients_on_release_date"
  end
